...
import * as monacoNsps from 'reactive-liquid-monaco-editor'
 ...
 */
export function wireTmGrammars(monaco: typeof monacoNsps, registry: Registry, editor?: monacoNsps.editor.ICodeEditor) {
    
    const languages = new Map()
    languages.set('reactive-liquid', 'source.reactive-liquid')
